...
public class GeUntradables
{
	...
	private static final int[] ITEM_IDS = new int[]
	{
		...
		// Charged Jewelry
		SKILLS_NECKLACE1, SKILLS_NECKLACE2, SKILLS_NECKLACE3, SKILLS_NECKLACE5,
		RING_OF_WEALTH_1, RING_OF_WEALTH_2, RING_OF_WEALTH_3, RING_OF_WEALTH_4,
		COMBAT_BRACELET1, COMBAT_BRACELET2, COMBAT_BRACELET3, COMBAT_BRACELET5,
		AMULET_OF_GLORY1, AMULET_OF_GLORY2, AMULET_OF_GLORY3, AMULET_OF_GLORY5,
		AMULET_OF_GLORY_T1, AMULET_OF_GLORY_T2, AMULET_OF_GLORY_T3, AMULET_OF_GLORY_T5,

		GAMES_NECKLACE1, GAMES_NECKLACE2, GAMES_NECKLACE3, GAMES_NECKLACE4,
		GAMES_NECKLACE5, GAMES_NECKLACE6, GAMES_NECKLACE7,

		RING_OF_DUELING1, RING_OF_DUELING2, RING_OF_DUELING3, RING_OF_DUELING4,
		RING_OF_DUELING5, RING_OF_DUELING6, RING_OF_DUELING7,

		NECKLACE_OF_PASSAGE1, NECKLACE_OF_PASSAGE2, NECKLACE_OF_PASSAGE3, NECKLACE_OF_PASSAGE4,
		BURNING_AMULET1, BURNING_AMULET2, BURNING_AMULET3, BURNING_AMULET4,
